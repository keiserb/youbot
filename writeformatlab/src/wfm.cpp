...
void wfm::lowermmstep(geometry_msgs::Pose object)
{
  ...
  if(positionReached(solve_ik(object)) && counter < 80)
  {
...
void wfm::lowertorque(geometry_msgs::Pose & object, trajectory_msgs::JointTrajectory & traj)
{
  ...
  {
    actionlib::SimpleActionClient<torque_control::torque_trajectoryAction> ac(
          "torque_control", true);
...
double* wfm::solve_ik(geometry_msgs::Pose object)
{
  ...
  fc_srv.request.des_position[2] = object.position.z;//+0.001*(32-counter);  //then lower it down
